...
const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        toast.success('Welcome back to Spicy Kart!');
  ...
  return (
    <div className="container flex items-center justify-center min-h-[calc(100vh-4rem)] py-12">
      <PageMeta title="Login | Spicy Kart" description="Access your Spicy Kart account to manage orders and profile." />
        ...
        <CardHeader className="space-y-4 pt-10 pb-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="text-base font-medium">
              Log in to your Spicy Kart account
            </CardDescription>
          </div>
        </CardHeader>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                type="password"
                placeholder="••••••••"
                className="h-12 rounded-xl bg-secondary/50 border-none focus-visible:ring-primary font-medium"
                value={password}
