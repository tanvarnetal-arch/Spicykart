...
import { type UseFirebaseUploadReturn } from '@/hooks/use-firebase-upload'
...
type DropzoneContextType = Omit<UseFirebaseUploadReturn, 'getRootProps' | 'getInputProps'>

const DropzoneContext = createContext<DropzoneContextType | undefined>(undefined)

type DropzoneProps = UseFirebaseUploadReturn & {
  className?: string
}
